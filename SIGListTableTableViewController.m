//
//  SIGListTableTableViewController.m
//  Signatures
//
...
#import "SIGListTableTableViewController.h"
#import "SIGListTableViewCell.h"

@interface SIGListTableTableViewController ()

@end

@implementation SIGListTableTableViewController
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        //will delete row when you swipe
